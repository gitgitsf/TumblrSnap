...
public class PhotosFragment extends Fragment {
	...
	public static final String APP_TAG = "MyTumblrSnap";
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		Log.d("debug", " onActivityCreated() " + TAG);
	...
	public void onLaunchCamera() {
		Log.d("debug", " onLaunchCamera() " + TAG);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		Log.d("debug", " onActivityResult() " + TAG);
	
		if (resultCode == Activity.RESULT_OK) {
			if (requestCode == TAKE_PHOTO_CODE) {
				handleTakenPicture(resultCode,  data);
			} else if (requestCode == PICK_PHOTO_CODE) {
				handlePickedPicture(resultCode,  data);
	...
	private void handleTakenPicture(int resultCode, Intent data) {
		Log.d("debug", " handleTakenPicture() " + TAG);
		if (resultCode == Activity.RESULT_OK) {
	...
	private void handlePickedPicture(int resultCode, Intent data) {
		Log.d("debug", " handlePickedPicture() " + TAG);
	...
	public Uri getPhotoFileUri(String fileName) {
		Log.d("debug", " getPhotoFileUri() " + TAG);
		...
		if (!mediaStorageDir.exists() && !mediaStorageDir.mkdirs()) {
			Log.d("debug", APP_TAG + " failed to create directory ");
		}
	...
	private static File getOutputMediaFile() {
		Log.d("debug", " getOutputMediaFile() " + TAG);
	    File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
	              Environment.DIRECTORY_PICTURES), APP_TAG);
	    if (!mediaStorageDir.exists() && !mediaStorageDir.mkdirs()){
	        return null;
